...
|--------|------|---------------|------|---------------------|------|------|------|------|------|------|------|
| LiquidAI/LFM2.5-1.2B-Instruct | Iluvatar | - | 16 | - | 10624.67 | 25183.0 | 934.92 | 4674.6 | 58.0 | 0 | - |

### V2
| 模型名 | 厂商 | TFLOPS（单卡） | 卡数 | TFLOPS（单卡） × 卡数 | 4k-1k 64并发 - mean TTFT（ms） | 4k-1k 64并发 - P99 TTFT（ms） | 4k-1k 64并发 - output toks/s | 4k-1k 64并发 - total tok/s | 4k-1k 64并发 - Mean TPOT (ms) | 开算子数 | 单算力吞吐 |
|--------|------|---------------|------|---------------------|------|------|------|------|------|------|------|
| LiquidAI/LFM2.5-1.2B-Instruct | Iluvatar | - | 16 | - | - | - | - | - | - | - | - |
...
2. 【FR】Bug: Operator performance degradation on iluvatar (LiquidAI/LFM2.5-1.2B-Instruct)
