...
|--------|------|---------------|------|---------------------|------|------|------|------|------|------|------|
| moonshotai/Moonlight-16B-A3B-Instruct | Ascend | - | 16 | - | - | - | - | 合成基线 | - | 0 | - |

### V2
| 模型名 | 厂商 | TFLOPS（单卡） | 卡数 | TFLOPS（单卡） × 卡数 | 4k-1k 64并发 - mean TTFT（ms） | 4k-1k 64并发 - P99 TTFT（ms） | 4k-1k 64并发 - output toks/s | 4k-1k 64并发 - total tok/s | 4k-1k 64并发 - Mean TPOT (ms) | 开算子数 | 单算力吞吐 |
|--------|------|---------------|------|---------------------|------|------|------|------|------|------|------|
| moonshotai/Moonlight-16B-A3B-Instruct | Ascend | - | 16 | - | - | - | - | - | - | 0 | - |
...
| 模型名 | 厂商 | TFLOPS（单卡） | 卡数 | TFLOPS（单卡） × 卡数 | 4k-1k 64并发 - mean TTFT（ms） | 4k-1k 64并发 - P99 TTFT（ms） | 4k-1k 64并发 - output toks/s | 4k-1k 64并发 - total tok/s | 4k-1k 64并发 - Mean TPOT (ms) | 开算子数 | 单算力吞吐 |
|--------|------|---------------|------|---------------------|------|------|------|------|------|------|------|
| moonshotai/Moonlight-16B-A3B-Instruct | Ascend | - | 16 | - | - | - | - | - | - | - | - |
...
issue 数量：3
issue 标题：
1. 【FR】Bug: Operator accuracy degradation on 华为(Ascend) (moonshotai/Moonlight-16B-A3B-Instruct)
2. 【FR】Bug: Operator crash on 华为(Ascend) (moonshotai/Moonlight-16B-A3B-Instruct)
3. 【FR】Bug: Operator performance degradation on 华为(Ascend) (moonshotai/Moonlight-16B-A3B-Instruct)
