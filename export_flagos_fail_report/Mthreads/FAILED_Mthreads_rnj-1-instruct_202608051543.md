...
|--------|------|---------------|------|---------------------|------|------|------|------|------|------|------|
| EssentialAI/rnj-1-instruct | Mthreads | - | 8 | - | 2415.58 | 2714.58 | 158.4 | 792.12 | 402.0 | 0 | - |

### V2
| 模型名 | 厂商 | TFLOPS（单卡） | 卡数 | TFLOPS（单卡） × 卡数 | 4k-1k 64并发 - mean TTFT（ms） | 4k-1k 64并发 - P99 TTFT（ms） | 4k-1k 64并发 - output toks/s | 4k-1k 64并发 - total tok/s | 4k-1k 64并发 - Mean TPOT (ms) | 开算子数 | 单算力吞吐 |
|--------|------|---------------|------|---------------------|------|------|------|------|------|------|------|
| EssentialAI/rnj-1-instruct | Mthreads | - | 8 | - | - | - | - | - | - | - | - |
...
issue 数量：2
issue 标题：
1. 【FR】Bug: Operator accuracy degradation on mthreads (EssentialAI/rnj-1-instruct)
2. 【FR】Bug: Operator performance degradation on mthreads (EssentialAI/rnj-1-instruct)
